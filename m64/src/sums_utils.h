...
extern int make_element(u32 pos, u32 prime, u32 prime_power, u32 nor,
...
extern int scaled_add(const char *m1, const char *m2, const char *m3, u32 scalar, const char *tmp);
