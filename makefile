...
ZDETF_MODULES=	rows detf psign zdetf
ZDET2_MODULES=	rows det psign zdet2
ZDIAG_MODULES=	rows zdiag
ZDIFF_MODULES=	rows zdiff
ZDIFFD_MODULES=	rows zdiffd
ZDMS_MODULES=	rows zdms dms det psign
ZDMS2_MODULES=	rows zdms2 dms2 det psign
ZDMSF_MODULES=	rows zdmsf dmsf detf psign
ZDMS2F_MODULES=	rows zdms2f dms2f detf psign
...
ZPS_MODULES=	zps
ZPSIGN_MODULES=	psign rows zpsign
ZPW_MODULES=	pw zpw rows
